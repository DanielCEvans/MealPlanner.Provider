...
namespace MealPlanner.Provider.Persistence.Migrations
{
    ...
    [Migration("20240616042923_ChangeIngredientTableToUseNaturalKey")]
    partial class ChangeIngredientTableToUseNaturalKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MealPlanner.Provider.Persistence.Models.Ingredient", b =>
                {
                    ...
                    b.HasKey("IngredientName", "MeasurementUnit");
            ...
            modelBuilder.Entity("MealPlanner.Provider.Persistence.Models.MealIngredients", b =>
                {
                    ...
                    b.HasKey("MealName", "IngredientName", "MeasurementUnit");

                    b.HasIndex("IngredientName", "MeasurementUnit");
            ...
            modelBuilder.Entity("MealPlanner.Provider.Persistence.Models.MealIngredients", b =>
                {
                    ...
                    b.HasOne("MealPlanner.Provider.Persistence.Models.Ingredient", "Ingredient")
                        .WithMany("MealIngredients")
                        .HasForeignKey("IngredientName", "MeasurementUnit")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
